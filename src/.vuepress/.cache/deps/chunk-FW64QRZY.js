...
var loader$i = async () => {
  const { diagram } = await import("./c4Diagram-f9e67060-PLMXVX7Z.js");
...
var loader$h = async () => {
  const { diagram } = await import("./flowDiagram-42bb1e4d-M35LC3EW.js");
...
var loader$g = async () => {
  const { diagram } = await import("./flowDiagram-v2-4c9a7611-Q2OJVL3R.js");
...
var loader$f = async () => {
  const { diagram } = await import("./erDiagram-25977acd-ALYTX4CI.js");
...
var loader$e = async () => {
  const { diagram } = await import("./gitGraphDiagram-30dcca6d-SYYPHEC4.js");
...
var loader$d = async () => {
  const { diagram } = await import("./ganttDiagram-41439120-2PCDPBGL.js");
...
var loader$c = async () => {
  const { diagram } = await import("./infoDiagram-1b335302-57DIACV4.js");
...
var loader$b = async () => {
  const { diagram } = await import("./pieDiagram-905ac727-GCSXCAYT.js");
...
var loader$a = async () => {
  const { diagram } = await import("./requirementDiagram-84e9ae78-J6BC5KVU.js");
...
var loader$9 = async () => {
  const { diagram } = await import("./sequenceDiagram-2c95880e-FJWLYLYS.js");
...
var loader$8 = async () => {
  const { diagram } = await import("./classDiagram-4456d403-ZHVNYV4Z.js");
...
var loader$7 = async () => {
  const { diagram } = await import("./classDiagram-v2-539b00ca-NS3FMITL.js");
...
var loader$6 = async () => {
  const { diagram } = await import("./stateDiagram-95825141-QYPH6ZT2.js");
...
var loader$5 = async () => {
  const { diagram } = await import("./stateDiagram-v2-1cc5d8ed-AJZZYEUE.js");
...
var loader$4 = async () => {
  const { diagram } = await import("./journeyDiagram-ded66ec9-UWP2S4QD.js");
...
var loader$3 = async () => {
  const { diagram } = await import("./errorDiagram-bb949655-LNB3KKDO.js");
...
var loader$2 = async () => {
  const { diagram } = await import("./flowchart-elk-definition-c9fc5e04-72YKHS2T.js");
...
var loader$1 = async () => {
  const { diagram } = await import("./timeline-definition-24ebf147-EWG6NLWY.js");
...
var loader = async () => {
  const { diagram } = await import("./mindmap-definition-c8a05b8a-DQCUQNDA.js");
  return { id, diagram };
};
var plugin = {
  id,
...
//# sourceMappingURL=chunk-FW64QRZY.js.map
