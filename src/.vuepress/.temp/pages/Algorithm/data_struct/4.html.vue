<template><div><p>「红黑树 Red Black Tree」</p>
<!-- more -->
<p>「红黑树 Red Black Tree」是在 「二叉搜索树 」的基础上对二叉树进行平衡操作的一种数据结构，这些平衡操作可以使得红黑树在动态维护当中仍然保持 <span class="katex"><span class="katex-mathml"><math xmlns="http://www.w3.org/1998/Math/MathML"><semantics><mrow><mi>O</mi><mo stretchy="false">(</mo><mi>l</mi><mi>o</mi><mi>g</mi><mi>n</mi><mo stretchy="false">)</mo></mrow><annotation encoding="application/x-tex">O(logn)</annotation></semantics></math></span><span class="katex-html" aria-hidden="true"><span class="base"><span class="strut" style="height:1em;vertical-align:-0.25em;"></span><span class="mord mathnormal" style="margin-right:0.02778em;">O</span><span class="mopen">(</span><span class="mord mathnormal" style="margin-right:0.01968em;">l</span><span class="mord mathnormal">o</span><span class="mord mathnormal" style="margin-right:0.03588em;">g</span><span class="mord mathnormal">n</span><span class="mclose">)</span></span></span></span> 的时间复杂度。</p>
<h2 id="红黑树的定义" tabindex="-1"><a class="header-anchor" href="#红黑树的定义" aria-hidden="true">#</a> 红黑树的定义</h2>
<p>「定义」</p>
<ol>
<li>结点是红色或者黑色</li>
<li>根结点是黑色</li>
<li>所有叶结点是黑色 (即值为 <code v-pre>null</code> 的结点 )</li>
<li>每个红色结点的两个叶子结点必须是黑色。(从每个叶子结点到根的所有路径上不能有连续的红色结点)</li>
<li>从任一结点到其子树的每个叶子结点的所有路径都包含相同数目的黑色结点</li>
</ol>
<p>「性质」</p>
<ul>
...
<p>所需操作：【<strong>旋转 + 变色</strong>】</p>
<p>当为中间两种情况时，可分别通过 左旋 或 右旋 转化为最两侧的两种情况：</p>
<ol>
<li>将 ”父结点“ 变为黑色</li>
<li>将 ”祖父结点” 变为红色</li>
<li>以 “祖父结点” 为原点进行<strong>右旋 (最左侧的情况)</strong> 或 <strong>左旋 (最右侧的情况)</strong></li>
</ol>
...
<li>删除黑色叶子结点 (不为 <code v-pre>null</code> 的叶子结点)
<ol>
<li>删除结点为根结点</li>
<li>待删除结点的兄弟结点为黑色
<ol>
...
<li>
<p>将父结点及兄弟结点的子结点染为黑色，兄弟结点染为红色</p>
</li>
</ol>
<p>如下图：</p>
...
<li>父结点变为黑色</li>
<li>兄弟结点变为红色</li>
<li>将父结点当作 “待删除的黑色叶子结点” 一样处理</li>
</ol>
<p>将父结点看作待删除的黑色叶子结点，则需要进行的后续操作如下：</p>
<ol>
<li>父结点变 &quot;黑色&quot;</li>
<li>兄弟结点变 &quot;红色&quot;</li>
