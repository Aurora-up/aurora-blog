<template><div><p>应用层协议 —— HTTP 协议</p>
<!-- more -->
...
<td style="text-align:center">其没有请求体，但有请求参数，虽然请求参数可以向服务器传送信息，但是请求参数只能明文传输，有安全隐患</td>
</tr>
<tr>
<td style="text-align:center"><code v-pre>POST</code></td>
<td style="text-align:center">向服务器发送数据</td>
<td style="text-align:center">没有请求参数，但有请求体，可以通过加密算法对请求体加密，相较于直接使用 <code v-pre>GET</code> 请求修改服务器中的数据更加安全</td>
</tr>
<tr>
<td style="text-align:center"><code v-pre>PUT</code></td>
<td style="text-align:center">向指定资源位置上传其最新内容</td>
<td style="text-align:center"></td>
</tr>
<tr>
<td style="text-align:center"><code v-pre>DELETE</code></td>
<td style="text-align:center">请求服务器删除指定的内容</td>
<td style="text-align:center"></td>
</tr>
<tr>
<td style="text-align:center"><code v-pre>HEAD</code></td>
<td style="text-align:center">获取报文首部</td>
<td style="text-align:center">与 <code v-pre>GET</code> 方法一样，只是不返回报文主体部分，通常用于确认 <code v-pre>URI</code> 的有效性及资源更新的日期时间等</td>
</tr>
</tbody>
</table>
...
<tbody>
<tr>
<td style="text-align:center"><code v-pre>Accept</code></td>
<td style="text-align:center">用户代理可处理的媒体类型</td>
</tr>
<tr>
<td style="text-align:center"><code v-pre>Accept-Charset</code></td>
<td style="text-align:center">优先的字符集</td>
</tr>
<tr>
<td style="text-align:center"><code v-pre>Accept-Encoding</code></td>
<td style="text-align:center">优先的内容编码</td>
</tr>
<tr>
<td style="text-align:center"><code v-pre>Accept-Language</code></td>
<td style="text-align:center">优先的语言(自然语言)</td>
</tr>
<tr>
<td style="text-align:center"><code v-pre>Authorization</code></td>
<td style="text-align:center">Web 认证信息</td>
</tr>
<tr>
<td style="text-align:center"><code v-pre>Expect</code></td>
<td style="text-align:center">期待服务器的特定行为</td>
</tr>
<tr>
<td style="text-align:center"><code v-pre>Host</code></td>
<td style="text-align:center">请求资源所在服务器</td>
</tr>
<tr>
<td style="text-align:center"><code v-pre>If-Match</code></td>
<td style="text-align:center">比较实体标记(ETag)</td>
</tr>
<tr>
<td style="text-align:center"><code v-pre>If-Modified-Since</code></td>
