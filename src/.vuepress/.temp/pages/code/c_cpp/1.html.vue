...
<h3 id="_1-指针表达式" tabindex="-1"><a class="header-anchor" href="#_1-指针表达式" aria-hidden="true">#</a> 1.指针表达式</h3>
<h3 id="_2-二级指针" tabindex="-1"><a class="header-anchor" href="#_2-二级指针" aria-hidden="true">#</a> 2.二级指针</h3>
<h2 id="指针运算" tabindex="-1"><a class="header-anchor" href="#指针运算" aria-hidden="true">#</a> 指针运算</h2>
<h2 id="指针类型" tabindex="-1"><a class="header-anchor" href="#指针类型" aria-hidden="true">#</a> 指针类型</h2>
<h3 id="_1-基本指针类型" tabindex="-1"><a class="header-anchor" href="#_1-基本指针类型" aria-hidden="true">#</a> 1.基本指针类型</h3>
<p>基本数据类型中有 <code v-pre>int</code> 整型，<code v-pre>float</code> 浮点数等等，这些基本类型都对应着基本指针类型，例如：<code v-pre>int*</code> ，<code v-pre>float*</code> 等。如下表：</p>
<table>
<thead>
<tr>
<th style="text-align:center">基本数据类型</th>
<th style="text-align:center">占用空间</th>
<th style="text-align:center">基本指针类型</th>
<th style="text-align:center">占用空间(32 或 64 位机器)</th>
</tr>
</thead>
<tbody>
<tr>
...
<td style="text-align:center"><code v-pre>char*</code></td>
<td style="text-align:center">4 或 8 字节</td>
</tr>
<tr>
...
<tr>
<td style="text-align:center"><code v-pre>long long</code></td>
...
<span class="token comment">/* 
	...
	之后的值也就是 00000001
*/</span>
<span class="token keyword">char</span><span class="token operator">*</span> pca <span class="token operator">=</span> <span class="token punctuation">(</span><span class="token keyword">char</span><span class="token operator">*</span><span class="token punctuation">)</span> pa<span class="token punctuation">;</span>   
<span class="token comment">// 将 00000001 转为 10 进制输出</span>
<span class="token function">print</span><span class="token punctuation">(</span><span class="token string">"%d\n"</span><span class="token punctuation">,</span> <span class="token operator">*</span>pca<span class="token punctuation">)</span><span class="token punctuation">;</span>          <span class="token comment">// 输出结果: 1</span>
<span class="token comment">// 进行指针运算, 将 pca 指向 00000100 所在地址并以 10 进制形式输出该地址的数据</span>
<span class="token function">print</span><span class="token punctuation">(</span><span class="token string">"%d\n"</span><span class="token punctuation">,</span> <span class="token operator">*</span><span class="token punctuation">(</span>pca <span class="token operator">+</span> <span class="token number">1</span><span class="token punctuation">)</span><span class="token punctuation">)</span><span class="token punctuation">;</span>    <span class="token comment">// 输出结果: 4</span>
...
<h3 id="_2-void-型指针和-null-以及-nullptr" tabindex="-1"><a class="header-anchor" href="#_2-void-型指针和-null-以及-nullptr" aria-hidden="true">#</a> 2.<code v-pre>void*</code> 型指针和 <code v-pre>NULL</code> 以及 <code v-pre>nullptr</code></h3>
<blockquote>
...
<blockquote>
<p><code v-pre>NULL</code> 和 <code v-pre>nullptr</code></p>
</blockquote>
<p><code v-pre>NULL</code> 本身就是一个特殊的指针变量，表示不指向任何东西，可以将 <code v-pre>NULL</code> 值赋值给一个指针变量使其不指向任何东西。</p>
<ul>
<li>在 C 语言中 <code v-pre>NULL</code> 的定义如下：</li>
</ul>
<div class="language-c line-numbers-mode" data-ext="c"><pre v-pre class="language-c"><code><span class="token macro property"><span class="token directive-hash">#</span><span class="token directive keyword">define</span> <span class="token macro-name">NULL</span> <span class="token expression"><span class="token punctuation">(</span><span class="token punctuation">(</span><span class="token keyword">void</span> <span class="token operator">*</span><span class="token punctuation">)</span><span class="token number">0</span><span class="token punctuation">)</span></span></span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>其<strong>会</strong>根据不同类型的指针隐式类型转换为响应的类型；</p>
<div class="language-c line-numbers-mode" data-ext="c"><pre v-pre class="language-c"><code><span class="token keyword">int</span><span class="token operator">*</span> pi <span class="token operator">=</span> <span class="token constant">NULL</span><span class="token punctuation">;</span>   <span class="token comment">// NULL 隐式转换为 int*</span>
...
<li>在 C++ 中，由于C++是强类型的语言的缘故，定义如下：</li>
</ul>
<div class="language-cpp line-numbers-mode" data-ext="cpp"><pre v-pre class="language-cpp"><code><span class="token macro property"><span class="token directive-hash">#</span><span class="token directive keyword">ifdef</span> <span class="token expression">__cplusplus</span></span>
    <span class="token macro property"><span class="token directive-hash">#</span><span class="token directive keyword">define</span> <span class="token macro-name">NULL</span> <span class="token expression"><span class="token number">0</span></span></span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><code v-pre>NULL</code> 被定为为了 <code v-pre>0</code>， <strong>不会</strong> 隐式的转换为其他类型，在 C++ 11 之后往往使用 <code v-pre>nullptr</code> 替代使用 <code v-pre>NULL</code>，<code v-pre>nullptr</code> 的本质是一个常量，实现代码大致如下：</p>
<div class="language-cpp line-numbers-mode" data-ext="cpp"><pre v-pre class="language-cpp"><code><span class="token keyword">const</span> <span class="token keyword">class</span> <span class="token keyword">nullptr</span> <span class="token punctuation">{</span>
...
<div class="language-cpp line-numbers-mode" data-ext="cpp"><pre v-pre class="language-cpp"><code><span class="token keyword">int</span> n <span class="token operator">=</span> <span class="token number">0</span><span class="token punctuation">;</span>
...
<h3 id="_3-字符指针" tabindex="-1"><a class="header-anchor" href="#_3-字符指针" aria-hidden="true">#</a> 3.字符指针</h3>
<p>对于 <code v-pre>char*</code> 指针来说，一般使用是直接作为指向某个字符的指针，例如：</p>
<div class="language-cpp line-numbers-mode" data-ext="cpp"><pre v-pre class="language-cpp"><code><span class="token keyword">char</span> c <span class="token operator">=</span> <span class="token char">'a'</span><span class="token punctuation">;</span>
...
<tr>
<td style="text-align:center">字符串存储在栈上，内容可修改</td>
<td style="text-align:center">指针存储在栈上，但是其他字符串内容存储在 <strong>字符串常量区</strong>，内容不可修改</td>
</tr>
<tr>
<td style="text-align:center"><code v-pre>sizeof(var)</code>等于数组中所有内容占用的空间</td>
<td style="text-align:center"><code v-pre>sizeof(var)</code> 等于指针变量的占用的空间</td>
</tr>
<tr>
<td style="text-align:center">只能使用 <code v-pre>0</code> 到 <code v-pre>size - 1</code> 之间的索引</td>
<td style="text-align:center">其索引的本质是进行指针运算，所以任何数都可以，但是越界的访问可能会出现问题，例如：有<code v-pre>char *pc</code> ，而 <code v-pre>pc[-1]</code> 是指 指针运算 <code v-pre>*(pc-1)</code></td>
</tr>
</tbody>
</table>
<div class="language-cpp line-numbers-mode" data-ext="cpp"><pre v-pre class="language-cpp"><code><span class="token keyword">char</span> b<span class="token punctuation">[</span><span class="token number">5</span><span class="token punctuation">]</span> <span class="token operator">=</span> <span class="token punctuation">{</span><span class="token char">'1'</span><span class="token punctuation">,</span> <span class="token char">'2'</span><span class="token punctuation">,</span> <span class="token char">'3'</span><span class="token punctuation">,</span> <span class="token char">'4'</span><span class="token punctuation">,</span> <span class="token char">'5'</span><span class="token punctuation">}</span><span class="token punctuation">;</span>
...
<li>上面第一个表达式中，pa 会先和 <code v-pre>[]</code> 结合，所以其就是数组，数组中的元素类型为 <code v-pre>int*</code> ，即存放多个指针的数组；</li>
<li>第二个表达式中，通过括号将 pa 与 <code v-pre>*</code> 先结合，使其成为整形指针，也即一维数组，再与 <code v-pre>[]</code> 结合，组成二维数组，即指针 pa 代表整个二维数组。</li>
</ul>
</div>
<blockquote>
<p>在使用数组指针前，首先需要明白 <code v-pre>数组名</code> 和 <code v-pre>&amp;数组名</code> 的区别，通过下面代码可看出区别</p>
</blockquote>
<div class="language-cpp line-numbers-mode" data-ext="cpp"><pre v-pre class="language-cpp"><code><span class="token keyword">int</span> a<span class="token punctuation">[</span><span class="token number">10</span><span class="token punctuation">]</span> <span class="token operator">=</span> <span class="token punctuation">{</span> <span class="token number">0</span> <span class="token punctuation">}</span><span class="token punctuation">;</span>
...
<li><code v-pre>数组名</code> 代表数组中 &quot;<strong>首元素</strong>&quot; 的地址</li>
<li><code v-pre>&amp;数组名</code> 代表 数组 的地址</li>
</ul>
<p>因为在 c 语言中数组的首元素代表的就是数组，所以上面两者是相同的.</p>
<ul>
<li><code v-pre>a + 1</code> 对应的地址比 <code v-pre>a</code> 的地址大 <code v-pre>4</code> 个字节，而数组是 <code v-pre>int</code> 类型的，所以 <code v-pre>a + 1</code> 代表的是数组中首元素的下一个元素的地址（也即第二个元素的地址）【<strong>一次移动一个元素</strong>】</li>
<li><code v-pre>&amp;a + 1</code> 对应的地址比 <code v-pre>&amp;a</code> 的地址大 <code v-pre>40</code> 个字节，也即是<strong>整个数组的长度</strong>，那么 <code v-pre>&amp;a + 1</code> 代表就是跨过整个数组中所有元素后的第一个地址。【<strong>一次移动一整个数组</strong>】</li>
</ul>
<blockquote>
<p>为数组指针赋值</p>
</blockquote>
...
<li>因为 <code v-pre>pa</code> 代表的是二维数组，它可以看作多个一维数组组成的数组，那么要将一维数组赋值给二维数组时，要将该 “首元素” 的地址，也即<strong>整个一维数组的地址</strong> ( <code v-pre>&amp;a</code> ) 赋值给 <code v-pre>pa</code>。</li>
</ul>
<blockquote>
<p>数组、指针作为函数参数，指针作为函数返回值</p>
</blockquote>
<h4 id="_1-一维参数" tabindex="-1"><a class="header-anchor" href="#_1-一维参数" aria-hidden="true">#</a> 1.一维参数</h4>
<div class="language-cpp line-numbers-mode" data-ext="cpp"><pre v-pre class="language-cpp"><code><span class="token keyword">void</span> <span class="token function">test1</span><span class="token punctuation">(</span><span class="token keyword">int</span> a<span class="token punctuation">[</span><span class="token punctuation">]</span><span class="token punctuation">)</span> <span class="token punctuation">{</span><span class="token punctuation">}</span>
...
<li><code v-pre>a[]</code> 等价于 <code v-pre>a[10]</code> ，且传参传的是数组名，是数组中<strong>首元素的地址</strong>，也即上述例子中的 <code v-pre>int*</code> ，所以 <code v-pre>int* a</code> 等价于 <code v-pre>int a[]</code> 和<code v-pre>int a[N]</code>；</li>
<li><code v-pre>int** a</code> 就是个二级指针，而一级指针 <code v-pre>int *a</code> 等价于数组 <code v-pre>int a[]</code> ，所以将二级指针中的一级指针变为数组，也即 <code v-pre>int* a[]</code> ，这也是等价 <code v-pre>int** a</code> 的。</li>
</ul>
<h4 id="_2-二维参数" tabindex="-1"><a class="header-anchor" href="#_2-二维参数" aria-hidden="true">#</a> 2.二维参数</h4>
<div class="language-cpp line-numbers-mode" data-ext="cpp"><pre v-pre class="language-cpp"><code><span class="token keyword">void</span> <span class="token function">test1</span><span class="token punctuation">(</span><span class="token keyword">int</span> a<span class="token punctuation">[</span><span class="token punctuation">]</span><span class="token punctuation">[</span><span class="token number">10</span><span class="token punctuation">]</span><span class="token punctuation">)</span> <span class="token punctuation">{</span><span class="token punctuation">}</span>
...
<li><code v-pre>int a[][10]</code> 等价于 <code v-pre>int a[10][10]</code> ，且二维数组声明时不能省略 <strong>列值</strong> ，具体参考:<RouterLink to="/demo/1.html">二维数组不能省略列值的原因</RouterLink></li>
</ul>
<p>指针作为参数时，也和上面分析一致，只需要注意指针和数组之间的关系以及运算符结合的优先级问题即可。</p>
<h4 id="_3-指针作为函数返回值" tabindex="-1"><a class="header-anchor" href="#_3-指针作为函数返回值" aria-hidden="true">#</a> 3.指针作为函数返回值</h4>
<div class="language-cpp line-numbers-mode" data-ext="cpp"><pre v-pre class="language-cpp"><code>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h3 id="_5-指针数组" tabindex="-1"><a class="header-anchor" href="#_5-指针数组" aria-hidden="true">#</a> 5.指针数组</h3>
<p>指针数组就是存放指针的数组，本质是数组，只是将平时使用的基本类型换成了指针。</p>
<p>声明形式如下：</p>
<div class="language-cpp line-numbers-mode" data-ext="cpp"><pre v-pre class="language-cpp"><code><span class="token keyword">int</span><span class="token operator">*</span> pa<span class="token punctuation">[</span>N<span class="token punctuation">]</span><span class="token punctuation">;</span>     <span class="token comment">// 一级指针数组</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><ul>
<li>在 <a href="#_4-%E6%95%B0%E7%BB%84%E6%8C%87%E9%92%88">数组指针</a> 中已经解释清楚优先级问题，基本的一级指针数组如上，多级指针数组也类似，理清优先级即可分清。</li>
</ul>
<p>字符串并不是基本类型，那么要使用字符串数组时，就可以使用指针数组实现：</p>
...
<span class="token keyword">int</span> <span class="token function">main</span><span class="token punctuation">(</span><span class="token keyword">int</span> argc<span class="token punctuation">,</span> <span class="token keyword">const</span> <span class="token keyword">char</span> <span class="token operator">*</span> argv<span class="token punctuation">[</span><span class="token punctuation">]</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
  ...
  <span class="token keyword">return</span> <span class="token number">0</span><span class="token punctuation">;</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_6-函数指针" tabindex="-1"><a class="header-anchor" href="#_6-函数指针" aria-hidden="true">#</a> 6.函数指针</h3>
<h3 id="_7-对象指针" tabindex="-1"><a class="header-anchor" href="#_7-对象指针" aria-hidden="true">#</a> 7.对象指针</h3>
<h3 id="_8-常量指针和指针常量以及指向常量的常指针" tabindex="-1"><a class="header-anchor" href="#_8-常量指针和指针常量以及指向常量的常指针" aria-hidden="true">#</a> 8.常量指针和指针常量以及指向常量的常指针</h3>
<blockquote>
<p>常量指针</p>
</blockquote>
<p>又称常指针，可以理解为常量的指针，<strong>是指针</strong>，且其<strong>指向的是常量</strong>，这个常量是指针的值（地址），而不是地址指向的值。也即：<strong>指向的地址是个常量</strong>。关键点：</p>
<ul>
<li>常量指针<strong>指向的对象不能通过这个指针来修改</strong>，可是仍然可以通过原来的声明修改；</li>
<li>常量指针可以被赋值为变量的地址，之所以叫常量指针，是<strong>限制</strong>了通过这个指针修改变量的值；</li>
<li>指针还可以指向别处，因为指针本身只是个变量，可以指向任意地址；</li>
</ul>
<p>例如：     标志：  <code v-pre>const *</code></p>
<div class="language-cpp line-numbers-mode" data-ext="cpp"><pre v-pre class="language-cpp"><code><span class="token keyword">int</span> <span class="token keyword">const</span><span class="token operator">*</span> p<span class="token punctuation">;</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><p>「常量指针」多用于指针作为参数时不想通过该参数改变指向对象的值时使用。</p>
<blockquote>
<p>指针常量</p>
</blockquote>
<p>本质是一个常量，而用指针修饰它。指针常量的值是指针，这个值因为是常量，所以不能被赋值。关键点：</p>
<ul>
<li>它是个常量！</li>
...
<p>例如：      标志：<code v-pre>* const</code></p>
<div class="language-cpp line-numbers-mode" data-ext="cpp"><pre v-pre class="language-cpp"><code><span class="token keyword">int</span><span class="token operator">*</span> <span class="token keyword">const</span> p<span class="token punctuation">;</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><blockquote>
<p>指向常量的常指针</p>
</blockquote>
<p>指向常量的指针常量就是一个常量，且它指向的对象也是一个常量。关键点：</p>
<ul>
<li>一个指针常量，指向的是一个指针对象；</li>
...
<h2 id="和-操作符" tabindex="-1"><a class="header-anchor" href="#和-操作符" aria-hidden="true">#</a> <code v-pre>* </code>  和 <code v-pre>&amp;</code> 操作符</h2>
<table>
<thead>
<tr>
<th style="text-align:center"><code v-pre>*</code> 操作符</th>
<th style="text-align:center">案例</th>
</tr>
</thead>
<tbody>
<tr>
<td style="text-align:center">「<strong>乘号</strong>」进行乘法运算</td>
<td style="text-align:center"><code v-pre>int a = b * c;</code></td>
</tr>
<tr>
<td style="text-align:center">「<strong>定义指针</strong>」定义指针变量时使用</td>
<td style="text-align:center"><code v-pre>int a = 10; int* p = &amp;a;</code></td>
</tr>
<tr>
<td style="text-align:center">「<strong>间接操作符</strong>」获取指针指向的数据</td>
<td style="text-align:center"><code v-pre>int a = 10; int* p = &amp;a; </code> 则有 <code v-pre>*p == a</code></td>
</tr>
</tbody>
</table>
<div class="hint-container warning">
...
<tbody>
<tr>
<td style="text-align:center">「<strong>逻辑与操作符</strong>」<strong>当且仅当都判断完</strong>两边条件都为假时，最后结果才是假</td>
<td style="text-align:center">在下面</td>
</tr>
<tr>
<td style="text-align:center">「<strong>按位与操作符</strong>」将按位与的操作数转化为二进制然后按位与</td>
<td style="text-align:center"><code v-pre>8&amp;7</code> 等价于<strong>二进制</strong>下<code v-pre>1000(2) &amp; 0111(2) ==0000(2)</code></td>
</tr>
<tr>
<td style="text-align:center">「<strong>取地址操作符</strong>」取出被使用的变量的地址</td>
<td style="text-align:center"><code v-pre>int a = 10; int* p = &amp;a; </code> 则有 <code v-pre>*p == a</code></td>
</tr>
</tbody>
</table>
...
<p>不同点：</p>
<ul>
<li><code v-pre>&amp;&amp;</code> 具有<strong>短路与</strong>的特性，即如果第一个表达式为 <code v-pre>false</code> 时，则不再计算第二个表达式，例如：</li>
</ul>
<div class="language-cpp line-numbers-mode" data-ext="cpp"><pre v-pre class="language-cpp"><code><span class="token keyword">int</span> n<span class="token punctuation">,</span> m <span class="token operator">=</span> <span class="token number">10</span><span class="token punctuation">,</span> <span class="token number">100</span><span class="token punctuation">;</span>
...
<li>当 <code v-pre>x &amp; 1 == 1</code> 时为奇数。</li>
</ul>
</div>
<h2 id="使用指针时的一些危险行为" tabindex="-1"><a class="header-anchor" href="#使用指针时的一些危险行为" aria-hidden="true">#</a> 使用指针时的一些危险行为</h2>
<h3 id="_1-操作符的使用" tabindex="-1"><a class="header-anchor" href="#_1-操作符的使用" aria-hidden="true">#</a> 1.<code v-pre>*</code> 操作符的使用</h3>
<blockquote>
<p>指针常量</p>
</blockquote>
...
<div class="language-cpp line-numbers-mode" data-ext="cpp"><pre v-pre class="language-cpp"><code><span class="token comment">//-------空指针-------//</span>
